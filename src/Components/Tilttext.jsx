...
const Tilttext = (props) => {
  ...
  return (
    ...
    <div id='ttt' ref={props.tiltRef} className='max-md:mt-[90vw] max-lg:pl-20 max-md:pl-3 mt-56 pl-28 w-fit max-md:'>
        <h1 className='uppercase max-md:tracking-[0.4vw] max-md:leading-[28vw]  max-md:text-[25vw] max-md:font-[anzo5] max max-lg:leading-[6.5vw] max-lg:text-[6vw] text-[4.3vw] font-[anzo2] leading-[5vw]'>II am <span id='Hmm' className='max-md:leading-[28vw]  max-md:text-[25vw] max-md:font-[anzo5] inline-flex text-black font-extrabold font-[anzo1]'>  Dark Mode</span><span className='max-md:hidden'>™</span></h1>
