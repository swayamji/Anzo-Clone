...
const Page4 = () => {
 ...
 useGSAP(function(){
  ...
  return (
    <div className='section4 bg-white max-md:h-[70vw] h-screen p-5 relative overflow-hidden '>
      ...
      <img className='rotatee max-md:top-5 w-[40vw] opacity-90 absolute right-10' src="src\assets\11383065.png" alt="" />
